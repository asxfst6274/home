            ...
            <div class="col-span-12 mt-6">
                <div class="intro-y block sm:flex items-center h-10">
                    ...
                    <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                        <a href="bank-card-add.php" class="btn btn-primary shadow-md mr-2">Add New Bank Card</a>
                    </div>
                </div>
                    ...
                    <table class="table table-report sm:mt-2">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center whitespace-nowrap">CVV</th>
                        ...
                        <tbody>
                            <tr class="intro-x">
                                ...
                                <td>John Doe</td>
                                <td class="text-center">75743833684</td>
