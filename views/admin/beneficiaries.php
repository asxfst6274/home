            ...
            <div class="col-span-12 mt-6">
                <div class="intro-y block sm:flex items-center h-10">
                    ...
                    <div class="flex items-center sm:ml-auto mt-3 sm:mt-0">
                        <a href="beneficiary-add.php" class="btn btn-primary shadow-md mr-2">Add New Beneficiary</a>
                    </div>
                </div>
                                                ...
                                                <ul class="dropdown-content border">
                                                    <li> <a href="javascript:;" class="dropdown-item"
                                                            data-tw-toggle="modal" data-tw-target="#viewModal"> <i
                                                                data-lucide="eye" class="w-4 h-4 mr-2"></i>
                                                            View</a> </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header border-0">
                    <h2 class="font-medium text-base mr-auto">Beneficiary Details</h2> <a data-tw-dismiss="modal"
