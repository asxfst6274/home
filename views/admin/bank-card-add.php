                ...
                <div class="intro-y overflow-auto lg:overflow-visible mt-2">
                    ...
                    <div class="intro-y box lg:mt-5">
                        ...
                        <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div>
                                <label for="update-profile-form-11" class="form-label">Type</label>
                                <select id="update-profile-form-8" class="form-select">
                                    <option value="same">Master Card</option>
                                    <option value="others">Other Banks</option>
                                    <option value="crypto">Cryptocurrency</option>
                                    <option value="paypal">Paypal</option>
                                    <option value="cashApp">Cash App</option>
                            ...
                            <div>
                                <label for="update-profile-form-11" class="form-label">Owner Name</label>
                                <input id="update-profile-form-11" type="text" class="form-control"
                                    placeholder="Owner Name" value="">
                            </div>
                            <div>
                                <label for="update-profile-form-11" class="form-label">Number</label>
                            ...
                            <div>
                                <div class="flex gap-1 items-end">
                                    <div class="w-24">
                                        <label for="update-profile-form-11" class="form-label">Expiry Date</label>
                                    ...
                                    <div class="flex-1">
                                        <label for="update-profile-form-11" class="form-label">CVV</label>
                                        <input id="update-profile-form-11" type="text" class="form-control"
                            ...
                            <div>
                                ...
                                <select id="update-profile-form-8" class="form-select" disabled>
                                    <option value="same">
                                        Blocked</option>
                                    <option value="others">Active</option>
                    ...
                    <div class="flex justify-center">
                        <button type="button" class="btn btn-primary mt-3">Add Bank Card</button>
                    </div>
